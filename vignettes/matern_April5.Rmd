...
coordsGpu = vclMatrix(terra::crds(coordsSp), nrow(terra::crds(coordsSp)), 
                      ncol(terra::crds(coordsSp)), type=theType)
...
streamsGpu <- clrng::createStreamsGpu(128*128)
zMatGpu = clrng::rnormGpu(c(ncol(outputBatchF), Nsim), 
                           streams=streamsGpu, Nglobal=c(128,128),
                           type = theType)
```
