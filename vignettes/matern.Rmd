...
```{r randomNormalsSim}
streamsGpu <- gpuBatchMatrix::createStreamsGpu(128*64)
zMatGpu = gpuBatchMatrix::rnorm(c(ncol(outputBatchF), Nsim), 
...
gpuBatchMatrix:::backsolveBatchBackend(
...
gpuBatchMatrix:::maternBatchBackend(Vbatch, coordsGpu, paramsBatch,  c(1,1), c(1,1),#c(64,64), c(16,16), 
                               0, nrow(paramsBatch), 10)

gpuBatchMatrix::maternBatch(Vbatch, coordsGpu, paramsBatch,  c(64,64), c(16,16), 1, nrow(coordsGpu))
