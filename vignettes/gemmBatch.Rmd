...
gpuBatchMatrix:::gemmBatchBackend(gpuA, gpuB, outputC, 4L, 4L,2L, 2L, FALSE, Nglobal)
as.matrix(outputC)



outputC2<-vclMatrix(0, nrow=8, ncol=8, type="float")
gpuBatchMatrix:::gemmBatchBackend(gpuAt, gpuB, outputC2, 4L, 4L,2L, 2L, TRUE, Nglobal)
as.matrix(outputC2)
...
#gpuBatchMatrix:::gemmBatchBackend(gpuA, gpuB1, outputC3, 4L, 2L, 1L, FALSE, Nglobal)
#as.matrix(outputC3)

C4<-gpuBatchMatrix::gemmBatch(gpuA, gpuB1, 4L, 4L,2L, 1L, FALSE, Nglobal)
as.matrix(C4)

C5<-gpuBatchMatrix::gemmBatch(gpuA1, gpuB, 4L, 4L,1L, 2L, FALSE, Nglobal)
as.matrix(C5)

C6<-gpuBatchMatrix::gemmBatch(gpuA1t, gpuB, 4L, 4L, 1L, 2L, TRUE, Nglobal)
as.matrix(C6)
...
C4<-gpuBatchMatrix::gemmBatch(gpuA, gpuB, 4L, 1L,2L, 2L, FALSE, Nglobal)
as.matrix(C4)
