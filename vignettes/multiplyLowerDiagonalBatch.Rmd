...
gpuBatchMatrix::multiplyLowerDiagonalBatch(output, Lg, diagg, zmatg, 
                                           diagIsOne = TRUE, 
                                           transformD = "sqrt",
                                           NlocalCache = 50)
...
gpuBatchMatrix::multiplyLowerDiagonalBatch(output, Lg, diagg, zmatg, diagIsOne = 1, transformD = "sqrt", Nglobal = c(4,4,1),
                      Nlocal = c(2,2,1),
                      NlocalCache = 50)
