...
gpuBatchMatrix::multiplyLowerDiagonalBatch(output=output, 
                                           L=Lg,
                                           D=diagg,
                                           B=zmatg,
                                           diagIsOne = TRUE,
...
gpuBatchMatrix::multiplyLowerDiagonalBatch(output, Lg, diagg, zmatg, diagIsOne = 1, 
                                           transformD = "sqrt", Nglobal = c(4,4,1),
                      Nlocal = c(2,2,1),
                      NlocalCache = 50)
